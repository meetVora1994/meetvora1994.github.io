    ...
    const projects = [
        {
            ...
            details: [
                "Converted legacy mobile applications from Java to Kotlin (Android) and from Objective-C to modern SwiftUI (iOS), significantly improving performance.",
                "Migrated both apps to Kotlin Multiplatform (KMP), unifying business logic and reducing development time by 40%.",
                "Developed native apps using MVVM architecture for BLE device setup and configuration.",
                "Integrated Google Maps API and REST API for field operations.",
            ],
        },
        {
            ...
            details: [
                "Built BLE-based installation tool for pairing devices with containers.",
                "Built both Android and iOS apps natively using Jetpack Compose (Kotlin) and SwiftUI with MVVM architecture.",
                "Ensured robust testing and seamless integration with installation workflows.",
                "Delivered user documentation and incorporated feedback iteratively.",
            ],
        },
        {
            ...
            details: [
                "Created a label printing app using MVVM and Firebase for data storage and OTP-based login.",
                "Implemented OTP-based login and custom label design tools.",
                "Synced local and cloud data for persistent access.",
                "Designed the entire UI — including logo and all screens — using Adobe Illustrator and Figma.",
            ],
        },
        {
            ...
            details: [
                "Developed a Kotlin-based news app with notifications and multimedia.",
                "Designed a responsive UI and integrated analytics for engagement tracking.",
            ],
        },
        {
            ...
            details: [
                "Built a GPS-based school bus tracking app with real-time updates.",
                "Used Firebase for data sync and notification services.",
            ],
        },
        {
            title: "MyEDU School App",
            company: "Hodusoft Pvt. Ltd.",
            details: [
                "Built a school communication app with messaging and file-sharing features.",
                "Focused on UI/UX and data privacy compliance.",
                "Enabled white-labeling for effortless customization and deployment across clients.",
            ],
        },
        {
            title: "HoduPhone",
            ...
            details: [
                "Developed SIP-based VoIP app for HoduPBX with low-latency call handling.",
                "Integrated core VoIP features and ensured high-quality communication.",
            ],
        },
    ]
